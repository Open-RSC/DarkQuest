...
```
cd existing_repo
git remote add origin https://gitlab.com/open-runescape-classic/darkquest.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/open-runescape-classic/darkquest/-/settings/integrations)
