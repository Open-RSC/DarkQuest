...
public class Config {
	public static String SERVER_IP = "gs.darkquest.org", CONF_DIR = System.getProperty("user.home") + File.separator + "DarkQuest", MEDIA_DIR = System.getProperty("user.home") + File.separator + "DarkQuest";
